...
const Skin = ({ list, func }) => {
  const handleSkin = () => {
    func(list.name, list.rarity.displayValue, list.description, list.images.icon, list.rarity.displayValue);
  }
  return (
    <div onClick={handleSkin} className={styles[list.rarity.displayValue] + ' ' + styles.card} key={list.id}>
