    ...
    <div className={styles.main}>
        ...
        <div className={styles.container1}>
            ...
            <div className={styles.container2}>
                ...
                <Pessoa imagem={"/matheus coco.webp"} nome={"Matheus Côcco"} cargo={"Dev"} descricao={"Matheus Coco é o membro mais criativo da equipe. Sua mente artística traz uma perspectiva única para a solução de problemas, e sua habilidade em transformar ideias em realidade é inigualável."} />
